...
<form action="{{ route('usuarios.update',$usuario->iddet) }}" method="POST">
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" name="nombrecli" id="nombrecli" class="form-control" value="{{ $usuario->nombre_cliente }}" readonly>
    </div>
    ...
    <div class="form-group mb-3">
        ...
        <input type="number" name="perfil" id="perfil" class="form-control" value="{{ $usuario->perfil }}" min=1 max=7 required>
    </div>

    <!-- Campo para la Fecha de Vencimiento -->
    <div class="form-group mb-3">
        <label for="fecha_vencimiento">Fecha de Vencimiento</label>
        <input type="date" name="fecha_vencimiento" id="fecha_vencimiento" class="form-control" value="{{ $usuario->fecha_vencimiento->format('Y-m-d') }}" required>
    </div>
