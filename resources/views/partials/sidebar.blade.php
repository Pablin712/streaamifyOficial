        ...
        <nav class="sb-sidenav accordion" id="sidenavAccordion">
            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                        ...
                        <div class="collapse" id="collapseAdministration" aria-labelledby="headingAdministration"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                @if (Auth::user()->hasPermissionTo('empleados'))
                                    ...
                                    <a class="nav-link" href="{{ route('inteligencia-negocio') }}">Inteligencia de Negocio</a>
                                @endif
                    ...
                    @if (Auth::user()->hasAnyPermission(['bancos.index', 'mne.index', 'empleado.recargas.index', 'costos', 'gastos']))
                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                        ...
                        <div class="collapse" id="collapseFinance" aria-labelledby="headingFinance"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                @endif
                                @if (Auth::user()->hasPermissionTo('mne.index'))
                                    <a class="nav-link" href="{{ route('mne.index') }}">Mi Negocio Efectivo</a>
                                @endif
                    ...
                    @if (Auth::user()->hasAnyPermission(['donna.planes', 'donna.suscripciones', 'donna.solicitudes', 'donna.referidos']))
                        ...
                        <div class="collapse" id="collapseDonna" aria-labelledby="headingDonna"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                @endif
                                @if (Auth::user()->hasPermissionTo('donna.suscripciones'))
                                    <a class="nav-link" href="{{ route('donna.suscripciones.index') }}">
                                        <i class="bi bi-check2-circle me-1"></i> Suscripciones
                                    </a>
                                @endif
