...
<div class="container">
    ...
    <form action="{{ route('empleados.update', $empleado->idemp) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="telefonoemp" id="telefonoemp" class="form-control" value="{{ $empleado->telefonoemp }}" required>
        </div>
        <div class="mb-3">
            <label for="usuarioemp" class="form-label">Usuario</label>
            <input type="text" name="usuarioemp" id="usuarioemp" class="form-control" value="{{ $empleado->usuarioemp }}" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <select name="idrol" id="idrol" class="form-select" required>
                ...
                <option value="bodeguero" {{ $empleado->idrol === 'bodeguero' ? 'selected' : '' }}>bodeguero</option>
        ...
        <div class="mb-3">
            ...
            <div class="mt-2">
                <img src="{{ $empleado->foto_url }}" alt="Foto de {{ $empleado->nombreemp }}" class="img-fluid rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
            </div>
            @endif
        </div>
