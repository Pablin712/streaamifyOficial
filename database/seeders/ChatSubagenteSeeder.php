    ...
    public function run(): void
    {
        $subagentes = [
            ...
            [
                ...
                'prompt_base' => 'Responde como asistente comercial firme, corto, profesional y orientado a llevar al cliente al siguiente paso.',
                'criterios' => [
                    'requiere_cliente' => false,
                    'estado_relacion' => ['lead'],
                ],
                'tools' => ['consultar_precios', 'consultar_combos', 'consultar_metodos_pago'],
                'prioridad' => 10,
                'activo' => true,
            ],
            [
