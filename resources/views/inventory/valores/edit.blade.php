...
<form action="{{ route('valores.update', $valor->idval) }}" method="POST">
    ...
    <div class="form-group mb-3">
        ...
        <input type="number" name="costoval" id="costoval" class="form-control" value="{{ $valor->costoval }}" step="0.01" required>
    </div>

    <!-- Campo para Pantallas Mínimas -->
    <div class="form-group mb-3">
        <label for="pantminval">Pantallas Mínimas</label>
        <input type="number" name="pantminval" id="pantminval" class="form-control" value="{{ $valor->pantminval }}" required>
    </div>

    <!-- Campo para Pantallas Máximas -->
    <div class="form-group mb-3">
        <label for="pantmaxval">Pantallas Máximas</label>
        <input type="number" name="pantmaxval" id="pantmaxval" class="form-control" value="{{ $valor->pantmaxval }}" required>
    </div>

    <!-- Campo para Meses -->
    <div class="form-group mb-3">
        <label for="mesesval">Meses</label>
        <input type="number" name="mesesval" id="mesesval" class="form-control" value="{{ $valor->mesesval }}" required>
    </div>
